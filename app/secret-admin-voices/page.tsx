    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded shadow">
          ...
          <p className="text-gray-600 mb-4">Create new monthly issues and publish them.</p>
        ...
        <div className="bg-white p-6 rounded shadow">
          ...
          <p className="text-gray-600 mb-4">Write, edit, and upload articles.</p>
        ...
        <div className="bg-white p-6 rounded shadow">
          ...
          <p className="text-gray-600 mb-4">Create and edit crossword puzzles.</p>
