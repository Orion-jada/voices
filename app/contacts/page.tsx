export default function ContactsPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-2xl">
      ...
      <div className="bg-white p-8 rounded shadow text-center space-y-4 border border-blue-50">
        <p className="text-lg text-black">We'd love to hear from you!</p>
        <p className="text-black">For inquiries, submissions, or feedback, please reach out to us at:</p>
        ...
        <p className="text-sm text-blue-800 mt-8">
